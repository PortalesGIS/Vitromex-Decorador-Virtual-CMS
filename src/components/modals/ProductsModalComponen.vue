            ...
            <div class="bg-white" style="width:434px; height:183px">               
                <div class="px-4">
                    ...
                    <div class="flex justify-evenly mt-7 ">
                        <button 
                        @click="cancelEditing"
                        class="bg-1f text-force-white w-44 h-8 ">Eliminar cambios</button>
                        <button 
                        @click="onReturn"
                        class="bg-white w-44 text-force-black h-8 border border-black ">Seguir editando</button>
                    </div>
                </div>  
            </div>
        </div>
    ...
    <div 
        ...
        <div class="w-full h-full flex items-center justify-center">
            <div class="bg-white" style="width:434px; height:183px">               
                <div class="px-4">
                    <div class="mt-5">
                        <p class="text-force-black text-xl font-bold uppercase">Guardar cambios del Producto</p>
                    </div>
                    <div class="mt-3">
                        <p
                        class="text-force-black text-sm font-normal"
                    ...
                    <div class="flex justify-evenly mt-7">
                        <button 
                        @click="onAccept"
                        class="bg-1f text-force-white w-44 h-8 ">Guardar cambios</button>
                        <button 
                        @click="onReturn"
                        class="bg-white w-44 text-force-black h-8 border border-black ">Seguir editando</button>
                    </div>
   ...
   <div 
        ...
        <div class="w-full h-full flex items-center justify-center py-5">
             <div class=" bg-white h-full overflow-y-auto"  style="width:664px; max-height:984px">
                ...
                <div class="px-9">
                    <p class="text-force-black font-bold">COMPLETAR DATOS DEL PRODUCTO</p>
                </div>
                ...
                <div class="mt-4 w-full h-36 bg-1f">
                    <div class="pl-16 pt-5">
                        <p class="uppercase text-xl text-force-white font-bold">Nombre del producto</p>
                        <p class="mt-2 text-force-white text-xs font-normal">Indica el nombre que se visualizará en la App y Web 3D.</p>
                        <input 
                        placeholder="value"
                        v-model="name"
                ...
                <div class="mt-10 px-16">
                    ...
                    <p class="mt-3 text-xs text-force-black font-normal">Carga los tipos de imágenes que se mostrarán dentro del catálogo de la App y Web 3D.</p>
                </div>  
                <div class="mt-6 px-16">
                    <p class="text-force-black font-semibold text-sm">Imagen del Producto</p>
                    <p class="mt-3 text-xs text-force-black font-normal">Carga las imágenes que visualizarán los usuarios dentro del detalle de los productos en la App. Puedes cargar hasta 3 imágenes.</p>
                </div> 
                    ...
                    <div class="flex justify-between items-center mt-2">
                        <div class="w-44 flex justify-center items-center cursor-pointer" >
                               <label for="inp">
                                ...
                                <p class="text-xs font-medium text-force-black ">Cambiar imagen</p>
                                <input 
                                @change="addFileimg1"   
                ...
                <div class="px-16 mt-9">
                        <p class="text-force-black font-semibold text-sm">Imagen Miniatura</p>
                        <p class="mt-3 text-xs text-force-black font-normal">Carga la imagen que se mostrará como vista previa 
                ...
                <div class="w-full flex justify-center items-center mt-5">
                    <button 
                    @click="nexPage"
                    class="bg-1f w-48 text-force-white py-1">Siguiente</button>
                </div>
                </div>
                <!-- page 2 -->
                <div v-if="page===1">
                    <div class="mt-4 w-full h-16 bg-1f">
                        <div class="pl-16 ">
                            ...
                            <p class="uppercase text-xl text-force-white font-bold">{{name}}</p>
                        </div>                    
                    </div>
                    ...
                    <div class="mt-4 px-16">
                        <p class="text-force-black text-sm font-semibold">Albedo</p>
                        <p class="mt-2 text-xs text-force-black font-normal">Agrega las texturas que darán color a los modelos aplicados en la experiencia de Realidad Aumentada en la App y Web 3D.</p>
                    </div>            
                    <div class="mt-5 px-16">
                    ...
                    <div class="mt-6 px-16">
                        <p class="text-force-black text-sm font-semibold">Normal</p>
                        <p class="mt-2 text-xs text-force-black font-normal">Agrega las texturas que darán relieve a los modelos aplicados en la experiencia de Realidad Aumentada en  la App y Web 3D.</p>
                    </div>            
                    <div class="mt-5 px-16">
                        <div class="w-44 h-28 bg-f5 flex justify-center items-center">
                            <label for="inpnormal">
                    ...
                    <div class="mt-5 px-16">
                        <div class="flex justify-center">
                            ...
                            <button  @click="nexPage" class="mx-2 w-44 h-8 bg-black text-force-white">Siguiente</button>                                
                        </div>
                    </div>
                </div>
                <!-- page 3 -->
                <div v-if="page===2" class="overflow-y-auto">
                    <div class="mt-4 w-full h-16 bg-1f">
                        <div class="pl-16 ">
                            <p class="text-force-white text-sm font-semibold pt-3">Producto</p>
                            <p class="uppercase text-xl text-force-white font-bold">{{name}}</p>
                        </div>                    
                    </div>
                    <div class="mt-5 px-16">
                        <p class="uppercase text-xl text-force-black font-bold ">Asignar Espacios</p>
                        <p class="mt-2 text-xs text-force-black font-normal">Selecciona dentro de los check box las opciones de Espacios correspondientes</p>
                    </div>
                    <div class=" px-16" style="max-height:633px; min-height:633px">
                        <div class="grid grid-cols-3 justify-center">
                            ...
                            <div class="py-4  flex justify-start items-center">
                                ...
                                <p class="pl-2 font-semibold text-force-black text-xs">{{aplication.name}}</p>
                            </div>
                            </div>                            
                        </div>
                    </div>
