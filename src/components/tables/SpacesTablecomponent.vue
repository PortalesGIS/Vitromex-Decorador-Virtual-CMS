    ...
    <div class=" w-full h-full bg-f5 ">
      <div class=" flex justify-between bg-1f">
          ...
          <div class="col-span-1 flex items-center justify-between mr-4">
              <p class="text-white text-sm  py-2">No.</p>
                <i class="fas fa-angle-down" style="color:white"></i></div>
          <div class="col-span-2 flex items-center justify-between mr-4">
              <p class="text-white text-sm  py-2">Imagen</p>
                <i class="fas fa-angle-down" style="color:white"></i></div>
          <div class="col-span-2 flex items-center justify-between mr-4">
              <p class="text-white text-sm  py-2">Nombre del espacio</p>
                <i class="fas fa-angle-down" style="color:white"></i></div>
          <div class="col-span-2 flex items-center justify-between mr-4">
              <p class="text-white text-sm  py-2">Fecha de Registro</p>
                <i class="fas fa-angle-down" style="color:white"></i></div>
      </div>
      <div class="bg-1f">
          <div class="mr-10"><p class="text-white text-sm  py-2">Editar</p></div>
      </div>
      </div>
